...
ALTITUDE = INITIAL_ALTITUDE # Meters.
...
while TOF <= MAX_TIME:
	...
	ALTITUDE += (NORMAL_ACCEL * TIME_STEP * TIME_STEP) # Meters.
	...
	LINEAR_EQNS_OF_MOTION_DICT["POSITION"].append(ALTITUDE)
...
TOF = 0.0 # Seconds.
THETA_DOT = 0.0 # Degrees per second.
THETA = 0.0 # Degrees.
NORMAL_ACCEL = 0.0 # Meters per second squared.
ALTITUDE = INITIAL_ALTITUDE # Meters.
ALPHA_DOT = 0.0 # Degrees per second.
ALPHA = 0.0 # Degrees.
...
while TOF <= MAX_TIME:
	...
	ALTITUDE += (NORMAL_ACCEL * TIME_STEP * TIME_STEP)
	...
	DIFFERENTIAL_EQNS_OF_MOTION_DICT["POSITION"].append(ALTITUDE)
...
INITIAL_ALTITUDE.plot(DF2.iloc[:]["TOF"], DF2.iloc[:]["POSITION"], color="r", label="DIFFERENTIAL AIRFRAME")
