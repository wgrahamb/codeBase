...
class CoverCenter(object):
    def __init__(self, LDC_polys, TCA_poly, TCA_subpolys, num_to_cover="all"):
        self.LDC_polys = LDC_polys
        self.TCA_poly = TCA_poly
        self.TCA_subpolys = TCA_subpolys
    ...
    def _shift_LDC(self):
        ...
        for i, (ldc, dist) in enumerate(self.LDC_dists):    
            ...
            print("\t - Num covering center: ", num_covering)
            print("\t - Dist to TCA Centroid: ", round(dist))
            shifts = 0
