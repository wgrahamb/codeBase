...
massAndMotor::massAndMotor(mslDataPacket *dataPacket, std::string inPutDataFile)
{
	...
	dataPacket->mslExitArea = mslExitArea;
	dataPacket->mslBurnOut = mslBurnOut;
	dataPacket->mslMass = mass;
	dataPacket->mslLaunchCg = launchCg;
	dataPacket->mslCgFromNose = cgFromNose;
