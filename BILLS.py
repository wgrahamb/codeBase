...
CURRENT_BALANCE = 1065.48
GROCERY_MONEY_SPENT_IN_JULY = 44.69 + 23.56 + 17.10
if GROCERY_MONEY_SPENT_IN_JULY > GROCERIES:
	print(f"GROCERY LIMIT EXCEEDED.")
BILLS_LEFT_IN_AUGUST = TOTAL_PER_MONTH - RENT - GROCERY_MONEY_SPENT_IN_JULY - STUDENT_LOANS - CAR_BILL - GASOLINE - CAR_INSURANCE_PLACEHOLDER
PAYING_BACK_DAD = 875
TUITION_REIMBURSEMENT = 1992
AT_END_OF_AUGUST = CURRENT_BALANCE - BILLS_LEFT_IN_AUGUST + PAYCHECK + TUITION_REIMBURSEMENT - PAYING_BACK_DAD
