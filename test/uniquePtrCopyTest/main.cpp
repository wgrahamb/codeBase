...
struct simpleMath
{
	...
	public:
		...
		simpleMath(value *inputValueStructure) : fxnValueOne(inputValueStructure) {}

		// Defined copy constructor.
		simpleMath(const simpleMath& newObject) : fxnValueOne(std::make_unique<value>(*newObject.fxnValueOne))
		{
		...
		// Pointer to "value."
		std::unique_ptr<value> fxnValueOne;
