...
TO DO:
TURN DYNAMICS2 INTO TWO FUNCTIONS.
	CONSTRUCT MISSILE. HAS ITS OWN INPUT (EMPLACEMENT, CONFIG, ETC). RETURNS STATE.
	FLY MISSILE. TAKES STATE AND OTHER THINGS AS AN INPUT. RETURNS STATE.
TURN LOGGING FUNCTIONS INTO GENERAL FUNCTIONS.
REAL MOTOR MODEL.
...
INITIAL_POS = npa([0.0, 10000.0]) # Meters.
INITIAL_VEL = npa([300.0, 10.0]) # Meters per second.
FIN_DEFLECTION_DEGREES = -6 # Degrees.
