...
public:
	...
	// Inputs.
	double finDeflectionOneDegrees;
	double finDeflectionTwoDegrees;
	double finDeflectionThreeDegrees;
	double finDeflectionFourDegrees;
	double missileCenterOfGravity;
	double motorTotalThrust;
	double dynamicPressure;
	double machSpeed; // and above from other modules

	double angleOfAttack; // derived
	double phiPrime; // derived
	double missileSpeed; // derived
	double nonRolledRollRate; // derived
	double nonRolledPitchRate; // derived
