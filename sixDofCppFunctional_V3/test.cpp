...
void aerodynamicAnglesAndConversions(Missile &missile)
{
	...
	missile.alphaRadians = atan2(missile.FLUVelocity[2], missile.FLUVelocity[0]);
...
int main()
{
	...
	InputFile >> ballistic >> INTEGRATION_METHOD >> phiRads >> thetaRads >> psiRads >> posE >> posN >> posU >> LogData >> ConsoleReport;
