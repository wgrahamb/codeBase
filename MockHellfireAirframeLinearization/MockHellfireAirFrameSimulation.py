...
while TOF <= MAX_TIME:
	...
	POSITION += (NORMAL_ACCEL * TIME_STEP * TIME_STEP) # Meters.
...
while TOF <= MAX_TIME:
	...
	POSITION += (NORMAL_ACCEL * TIME_STEP * TIME_STEP)
...
THETA_DOT_PLOT.plot(DF2.iloc[:]["TOF"], DF2.iloc[:]["THETA_DOT"], color="r", label="DIFFERENTIAL AIRFRAME")
...
# THETA_PLOT.plot(DF1.iloc[:]["TOF"], DF1.iloc[:]["THETA"], color="b", label="LINEAR AIRFRAME")
THETA_PLOT.plot(DF2.iloc[:]["TOF"], DF2.iloc[:]["THETA"], color="r", label="DIFFERENTIAL AIRFRAME")
